      ...
      <div className="container-fluid">
        <div className="row service-single-container">
          <div className="col-lg-6">
            ...
            >
              I help people struggling with depression, a thorough assessment of
              one's needs and tailoring therapy to suit them <br />
              <br /> A little more about Depression therapy and what one should
              expect should they book a session for this service
            </Typography>
          </div>
          <div className="col-lg-6">
